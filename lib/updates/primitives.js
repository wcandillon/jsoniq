...
InsertIntoObject.prototype.inverse = function(){
    return new DeleteFromObject(this.target, Object.keys(this.pairs));
};
...
InsertIntoArray.prototype.inverse = function(){
    return new DeleteFromArray(this.target, this.position);
};
...
DeleteFromObject.prototype.inverse = function(store) {
    var pairs = {};
    var item = store.get(this.target);
    this.keys.forEach(function(key) {
        pairs[key] = item[key];
    });
    return new InsertIntoObject(this.target, pairs);
};
...
DeleteFromArray.prototype.inverse = function(store) {
    var item = store.get(this.target)[this.position];
    return new InsertIntoArray(this.target, this.position, item);
};
...
ReplaceInArray.prototype.inverse = function(store) {
    var item = store.get(this.target);
    return [
        new DeleteFromArray(this.target, this.position),
        new InsertIntoArray(this.target, this.position, item[this.position])
    ];
};
...
ReplaceInArray.prototype.inverse = function(store) {
    var item = store.get(this.target);
    return [
        new DeleteFromArray(this.target, this.key),
        new InsertIntoArray(this.target, this.key, item)
    ];
};
...
RenameInObject.prototype.inverse = function(store) {
    var item = store.get(this.target);
    return [
        new DeleteFromObject(this.target, this.newKey),
        new InsertIntoObject(this.target, this.key, item)
    ];
};
