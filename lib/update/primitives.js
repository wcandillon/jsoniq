...
var UpdatePrimitive = function(target){
    this.target = target;
};
 ...
 */
var InsertIntoObject = function(target, pairs){
 ...
 */
var InsertIntoArray = function(target, position, items){
    UpdatePrimitive.call(this, target);
 ...
 */
var DeleteFromObject = function(target, pairs){
    UpdatePrimitive.call(this, target);
    this.pairs = pairs;
};
 ...
 */
var DeleteFromArray = function(target, position){
    UpdatePrimitive.call(this, target);
    this.position = position;
};
 ...
 */
var ReplaceInArray = function(target, position, item){
    UpdatePrimitive.call(this, target);
    this.position = position;
    this.item = item;
};
 ...
 */
var ReplaceInObject = function(target, pair, value){
    UpdatePrimitive.call(this, target);
    this.pair = pair;
    this.value = value;
};
 ...
 */
var RenameInObject = function(target, pairName, newPairName){
    UpdatePrimitive.call(this, target);
