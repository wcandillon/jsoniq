...
PUL.prototype.replaceInObject = function(target, pair, value){
    ...
    this.udps.replaceInObject.forEach(function(primitive){
        primitive.validate(newPrimitive);
    });
    this.udps.replaceInObject.push(newPrimitive);
...
PUL.prototype.renameInObject = function(target, pairName, newPairName){
    ...
    this.udps.renameInObject.forEach(function(primitive){
        primitive.validate(newPrimitive);
    });
    this.udps.renameInObject.push(newPrimitive);
