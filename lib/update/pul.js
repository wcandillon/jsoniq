...
PUL.prototype.insertIntoObject = function(target, pairs) {
    ...
    var udp = _.find(this.upds.insertIntoObject, { target: target });
    if(udp) {
        udp.merge(newUdp);
    } else {
        this.upds.insertIntoObject.push(newUdp);
    }
    return this;
};
...
PUL.prototype.insertIntoArray = function(target, position, items) {
    ...
    var udp = _.find(this.upds.insertIntoArray, { target: target, position: position });
    if(udp) {
        udp.merge(newUdp);
    } else {
        this.upds.insertIntoArray.push(newUdp);
    }
    return this;
};
...
PUL.prototype.deleteFromObject = function(target, pairs){
    ...
    var udp = _.find(this.upds.deleteFromObject, { target: target });
    if(udp) {
        udp.merge(newUdp);
    } else {
        this.upds.deleteFromObject.push(newUdp);
    }
    return this;
};
...
PUL.prototype.deleteFromArray = function(target, position){
    ...
    //Multiple UPs of this type with the same (array,index) target are merged into one UP with this target.
    var udp = _.find(this.upds.deleteFromArray, { target: target, position: position });
    if(!udp) {
        this.upds.deleteFromArray.push(newUdp);
    }
    return this;
};
